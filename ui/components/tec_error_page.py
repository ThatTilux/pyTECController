            ...
            html.Div(
                ...
                children=html.Div(
                    ...
                    children=[
                        ...
                        html.P(
                            "Some TECs are have encountered an error and are currently rebooting. Trying to reconnect..."
                        ),
                        download_btn(
                            "btn-download-csv-reconnecting", "Download data as CSV"
                        ),
                    ],
                ),
            )
